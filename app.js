...
function userForm(u = {}) {
  ...
  <div class="fg"><label>Full Name</label><input class="fc" id="f_n" value="${u.name||''}"></div>
  ...
  <div class="fg" style="flex-direction:row;align-items:flex-end;gap:8px">
    <div class="fg" style="flex:1"><label>Phone</label><input class="fc" id="f_ph" value="${u.phone||u.phoneNumber||''}" placeholder="01XX-XXXXXXX"/></div>
